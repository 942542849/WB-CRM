...
$.post("edit.action",{id:id}, function(json) {
	render('myform', json);
	getlist("getCustomers.action",{},"[name=customer_id]",json.customer_id);
	getarray("getOptstates.action",{},"[name=optstate]",json.optstate);
	getlist("getUsers.action",{},"[name=user_id]",json.user_id);
