...
$.post("edit.action",{id:id}, function(json) {
	render('myform', json);
	getlist("getUsers.action",{},"[name=user_id]",json.department_id);
	getlist("getLevels.action",{},"[name=level_id]",json.role_id);
	getlist("getPleaseds.action",{},"[name=pleased_id]",json.role_id);
	getlist("getCredits.action",{},"[name=credit_id]",json.role_id);
},"json");
